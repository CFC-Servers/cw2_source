CustomizableWeaponry:addFireSound("CW_SVD_OFFICIAL_FIRE", "weapons/cw_svd_official/fire.wav", 1, 120, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_SVD_OFFICIAL_FIRE_SUPPRESSED", "weapons/cw_svd_official/fire_suppressed.wav", 1, 100, CHAN_STATIC)
